...
Assets.prototype.getGroupedUrls = function (name, _options) {
  ...
  var groups = DEFAULT_ASSET_GROUPS;
 ...
 * @param {string} options.groups Filter out the type of asset, accepted values 'link' | 'script'
 * @returns {string}
 */
Assets.prototype.constructAssetHTML = function (name, options) {
  ...
  var groupedUrls = this.getGroupedUrls(name, {
    groups: options.groups || DEFAULT_ASSET_GROUPS
  });
