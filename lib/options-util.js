...
function _parseAssetsOpts(baseDir, assetsNames, options) {
  var parsed = {};
...
function parseAssetsOpts(baseDir, options) {
...
function parseOpts(options) {
  ...
  var destDir = path.join(baseDir, options.destDir || 'dist');
  ...
  return {
    ...
    baseUrl: baseUrl,
    silent: silent,
    assets: parseAssetsOpts(baseDir, options.assets)
  };
}
module.exports = {
  parseOpts: parseOpts
